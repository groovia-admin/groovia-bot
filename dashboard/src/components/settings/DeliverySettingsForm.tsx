...
export default function DeliverySettingsForm({ initial }: { initial: Partial<DeliverySettings> | null }) {
  ...
  return (
    <form onSubmit={handleSave} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
      ...
      {allowDelivery && (
        <div style={{ display: "flex", flexDirection: "column", gap: 14, paddingLeft: 14, borderLeft: "2px solid var(--surface-border)" }}>
      ...
      {taxEnabled && (
        <div style={{ paddingLeft: 14, borderLeft: "2px solid var(--surface-border)" }}>
