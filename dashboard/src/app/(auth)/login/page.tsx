...
export default function LoginPage() {
  ...
  const s = {
    ...
    btn:   { width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', padding: '11px', borderRadius: '8px', border: 'none', background: 'var(--brand)', color: '#fff', fontSize: '14px', fontWeight: 600, cursor: 'pointer', fontFamily: 'inherit', position: 'relative' } as React.CSSProperties,
  ...
  // Plain rotating-arc spinner — swapped in for the earlier cart-runs-
  // through-the-button micro interaction, which read as playful/thematic
  // rather than the standard SaaS-product loading affordance asked for.
    ...
    <div style={{ minHeight: '100vh', display: 'flex' }}>
      ...
      >
        ...
        <div style={{ position: 'relative', display: 'flex', alignItems: 'center', gap: '12px' }}>
          <GrooviaMark size={30} color="#ffffff" />
          <span style={{ color: '#fff', fontSize: '17px', fontWeight: 800, letterSpacing: '-0.01em' }}>GrooVia</span>
        </div>
        ...
        <div style={{ position: 'relative', maxWidth: '440px' }}>
          ...
          <p style={{ color: 'rgba(255,255,255,0.75)', fontSize: '14.5px', lineHeight: 1.6, margin: 0 }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '14px', marginTop: '32px' }}>
            {FEATURES.map((f) => (
              <div key={f.text} style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                ...
                <span style={{ color: 'rgba(255,255,255,0.9)', fontSize: '13.5px', fontWeight: 500 }}>{f.text}</span>
              </div>
            ))}
          </div>
        </div>

        <p style={{ position: 'relative', color: 'rgba(255,255,255,0.45)', fontSize: '11.5px', margin: 0 }}>
      ...
      {/* Right side — the existing login form, unchanged, just no longer
          centered full-width. */}
      <div className="login-form-side" style={{ flex: '0 0 auto', width: '100%', maxWidth: '520px', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '16px', background: 'var(--surface)', minHeight: '100vh' }}>
